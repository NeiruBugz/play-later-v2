...
3.  **Discover Available Domain Experts:** Scan the system for the registered agents directory to identify available specialist agents. For each agent file found:
