...
- [x] **Slice 1: Update Prisma schema and generate migration**
  ...
  - [x] Generate Prisma migration: `pnpmprisma migrate dev --name savepoint_vision_migration`
  - [x] Regenerate Prisma client: `pnpmprisma generate`
  - [x] Verify migration on local database using `pnpmprisma studio`
...
- [x] **Slice 2: Create JournalEntry database foundation**
  ...
  - [x] Generate migration: `pnpmprisma migrate dev --name add_journal_entry`
  - [x] Regenerate Prisma client: `pnpmprisma generate`
  - [x] Verify JournalEntry table exists using `pnpmprisma studio`
...
- [x] **Slice 3: Refactor backlog repository to library repository**
  ...
  - [x] Run typecheck: `pnpmtypecheck` (expect errors in features, will fix later)
...
- [x] **Slice 6: Refactor "Add Game" feature to use LibraryItem**
  ...
  - [x] Run tests: `pnpmrun test features/add-game` and fix any failures
...
- [x] **Slice 7: Refactor "Manage Backlog Item" feature to "Manage Library Item"**
  ...
  - [x] Run tests: `pnpmrun test features/manage-library-item` and fix failures
...
- [x] **Slice 8: Refactor "View Collection" feature**
  ...
  - [x] Run tests: `pnpmrun test features/view-collection`
...
- [x] **Slice 9: Refactor Dashboard feature**
  ...
  - [x] Run tests: `pnpmrun test features/dashboard`
...
- [x] **Slice 10: Refactor "View Game Details" feature**
  ...
  - [x] Run tests: `pnpmrun test features/view-game-details`
...
- [x] **Slice 11: Refactor remaining features (Steam integration, wishlist, imported games)**
  ...
  - [x] Run typecheck: `pnpmtypecheck` (should have zero errors)
...
- [x] **Slice 13: Update test factories and utilities**
  ...
  - [x] Run tests: `pnpmrun test` (expect many failures, will fix next)
...
- [x] **Slice 14: Fix failing unit and integration tests**
  ...
  - [x] Fix any remaining test failures revealed by `pnpmrun test`
  - [x] Achieve >80% test coverage: `pnpmrun test:coverage`

## Phase 7: Final Verification and Cleanup

- [ ] **Slice 15: Code quality and final verification**
  - [ ] Run full typecheck: `pnpmtypecheck` (zero errors)
  - [ ] Run linter: `pnpmlint` and fix any issues
  - [ ] Run formatter: `pnpmformat:check` and fix with `pnpmformat:write`
  - [ ] Run full test suite: `pnpmrun test` (all tests passing)
  - [ ] Clear Next.js cache: `rm -rf .next`
  - [ ] Start dev server: `pnpmdev` (should start without errors)
...
- [x] **Slice 18: Final schema cleanup**
  ...
  - [x] Generate final migration: `pnpmprisma migrate dev --name rename_backlog_table_to_library`
  - [x] Regenerate Prisma client: `pnpmprisma generate`
  - [x] Verify table is now named "LibraryItem" in Prisma Studio
  - [x] Run full test suite one final time: `pnpmrun test`
...
**Rollback Strategy**: If any slice fails, the previous slices remain working. Can rollback database with `pnpmprisma migrate reset`.
